# Super-Resolution GANs for Medical Images

## Overview
This project implements **Super-Resolution Generative Adversarial Networks (SRGANs)** for enhancing the resolution of medical images. The goal is to improve the visual quality and diagnostic utility of low-resolution medical images, such as those obtained from low-cost equipment or compressed storage formats. SRGANs leverage deep learning to reconstruct high-resolution images while preserving critical anatomical details.
